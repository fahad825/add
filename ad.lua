...
local ResultUI = player.PlayerGui.PAGES
--game:GetService("Players").PhillyDRIPPY.PlayerGui.PAGES.MatchResultPage
...
local function endGameFunc ()
	...
	task.spawn(function()
		...
		while true do
			...
			elseif  GetSave(AutoRetry.Name) and ResultUI.MatchResultPage.Banner.TextLabel.Text == 'Defeat!' then
                --game:GetService("Players").PhillyDRIPPY.PlayerGui.PAGES.MatchResultPage.Banner.TextLabel
				if LevelData.floor_num then
			...
			elseif GetSave(AutoNextLevel.Name) and ResultUI.MatchResultPage.Banner.TextLabel.Text ~= 'Defeat!' then
...
local function webhook ()
	...
	local result = getMapName(ResultUI.MatchResultPage.Banner.TextLabel.Text) if string.find(result, 'Defeat!') and GetSave(PingDefeatCHB.Name) and LevelData._gamemode ~= 'infinite' then ping = true end
	local newGems = ""
